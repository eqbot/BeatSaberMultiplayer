...
namespace BeatSaberMultiplayer.Misc
{
    public class SongDownloader : MonoBehaviour
    {
        ...
        {
            UnityWebRequest wwwId = GetRequestForUrl($"{Config.Instance.BeatSaverURL}/maps/hash/" + levelId.ToLower());
            wwwId.timeout = 10;
            ...
            {
                Plugin.log.Error($"Unable to fetch song by hash! {wwwId.error}\nURL:" + $"{Config.Instance.BeatSaverURL}/maps/hash/" + levelId.ToLower());
            }
            else
            {
